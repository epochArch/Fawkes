 ...
 * 
 */
public class FawkesHessianProxy implements InvocationHandler {

	private static final Logger log = LoggerFactory.getLogger(FawkesHessianProxy.class);

	private FawkesHessianProxyFactory _factory;
	...
	public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
		...
		if (mangleName == null) {
			...
			if (methodName.equals("equals") && params.length == 1 && params[0].equals(Object.class)) {
				...
				FawkesHessianProxy handler = (FawkesHessianProxy) Proxy.getInvocationHandler(value);
